...
bool scan::getSetup(void)
{
    ...
    if (respSize == (27*2 + 5) && responseBuffer[0] == _slaveID)
    {
        ...
        dataFromBEFrame(_commMode, uint16, responseBuffer, 5);
        ...
        dataFromBEFrame(_baudRate, uint16, responseBuffer, 7);
        ...
        dataFromBEFrame(_parity, uint16, responseBuffer, 9);
        ...
        dataFromBEFrame(_configRegNumber, pointer, responseBuffer, 13);
        dataFromBEFrame(_configRegType, pointerType, responseBuffer, 13);
        ...
        dataFromBEFrame(_scanPoint, character, responseBuffer, 15, 27);
        ...
        dataFromBEFrame(_cleaningMode, uint16, responseBuffer, 27);
        ...
        dataFromBEFrame(_cleaningInterval, uint16, responseBuffer, 29);
        ...
        dataFromBEFrame(_cleaningDuration, uint16, responseBuffer, 31);
        ...
        dataFromBEFrame(_cleaningWait, uint16, responseBuffer, 33);
        ...
        uint32_t secsPast1970;
        dataFromBEFrame(secsPast1970, timestamp, responseBuffer, 35);
        ...
        dataFromBEFrame(_measInterval, uint16, responseBuffer, 47);
        ...
        dataFromBEFrame(_loggingMode, uint16, responseBuffer, 49);
        ...
        dataFromBEFrame(_loggingInterval, uint16, responseBuffer, 51);
        ...
        dataFromBEFrame(_numLoggedResults, uint16, responseBuffer, 53);
        ...
        dataFromBEFrame(_indexLogResult, uint16, responseBuffer, 55);
...
bool scan::dataFromBEFrame(uint16_t outputVar, dataTypes regType, byte indata[], int start_index, int end_index)
{
    switch (regType)
    {
        case uint16:
...
bool scan::dataFromBEFrame(float outputVar, dataTypes regType, byte indata[], int start_index, int end_index)
{
    switch (regType)
    {
        case uint16: return false;
        case bitmask: return false;
...
bool scan::dataFromBEFrame(uint32_t outputVar, dataTypes regType, byte indata[], int start_index, int end_index)
{
    switch (regType)
    {
        case uint16: return false;
        ...
        case timestamp:
        {
            ...
            // Reverse the order of bytes to get from big-endian to little-endian
            Sefram.Byte[0] = indata[start_index + 5];
            Sefram.Byte[1] = indata[start_index + 4];
            Sefram.Byte[2] = indata[start_index + 3];
            Sefram.Byte[3] = indata[start_index + 2];
            outputVar = Sefram.Int;
            return true;
        }
        default: return false;
